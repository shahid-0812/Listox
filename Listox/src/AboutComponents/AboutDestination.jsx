...
export const AboutDestination = () => {
    return (
        <div className='max-w-7xl w-full mx-auto border border-[#e2e2e2] rounded-3xl mt-10 flex overflow-hidden items-center gap-5'>
            <div className='w-1/2 h-full'>
                <img src="/home/image-15.jpg" alt="" className='w-full h-full object-cover' />
            </div>
            <div className="flex flex-col gap-5 w-1/2 px-15">
                <Heading
                ...
                <div className="flex flex-col ">
                    <div className="flex gap-3 border-b border-[#e2e2e2] pb-8">
                        <span className='bg-[#ed5548] text-white text-3xl rounded-full px-5.5 py-5'>
