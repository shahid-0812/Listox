    ...
    return (
        <div className="flex justify-center items-center gap-10 relative max-w-7xl mx-auto w-full py-25">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-5 border-b border-[#e2e2e2] pb-5">
                    <div className="flex items-center gap-3">
                        <span className='bg-[#6053F0] text-white text-4xl rounded-full px-5.5 py-5'>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl bold tracking-normal">Select the best places on phone</span>
                    </div>
                </div>
