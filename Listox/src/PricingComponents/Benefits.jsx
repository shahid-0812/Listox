    ...
    return (
        <div className='max-w-7xl w-full mx-auto py-15 flex justify-center pt-50  items-center gap-50 max-lg:gap-35 max-lg:px-5 max-sm:flex-col max-sm:gap-5'>
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex justify-between items-center gap-5 border-b pb-5 border-[#e2e2e2] group">
                        ...
                        <span className='group-hover:bg-[#ed5548] group-hover:text-white transition duration-300 rounded-full px-4 py-3'>
