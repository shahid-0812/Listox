...
export const DestinationTwo = () => {
    ...
    return (
        <div className='max-w-7xl w-full mx-auto py-15 flex -translate-y-40 max-lg:translate-y-0 max-lg:px-5'>
            <div className="w-1/2 flex flex-col justify-between  gap-5 px-18 pt-18 bg-white">
                <Heading
                        ...
                        Places.map((place, index) => (
                            <div key={index} className="flex justify-between items-center bg-[#f0f0f0] pr-5 rounded-lg overflow-hidden hover:bg-[#6053f01c] transition duration-300 cursor-pointer">
                                <div className="flex items-center gap-5 ">
                                    ...
                                    <h1 className='text-xl bold'>{place}</h1>
                                </div>
            ...
            <div className="w-1/2 relative">
                <img src="/home/gallery-1.jpg" alt="" className="w-full h-full object-cover" />
                <div className="absolute bottom-0 left-0 rounded-r-full backdrop-blur-lg flex flex-col gap-3 px-10 text-white py-15">
